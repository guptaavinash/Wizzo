...
-- =============================================
--[spRptGetFullSalesHierarchyBasedonLogin]4492,0,0,'2^100^3^110^|'
CREATE PROCEDURE [dbo].[spRptGetFullSalesHierarchyBasedonLogin] 
@LoginId INT,
@NodeId int=0,
@NodeType int=0,
...
BEGIN
	...
	SELECT DISTINCT RSMAreaID,RSMAreaType,RSMArea,StateHeadAreaID,StateHeadAreaNodeType,StateHeadArea,ASMAreaID,ASMAreaNodeType,ASMArea,SOAreaID,SOAreaNodeType,SOArea,DSRAreaID,DSRAreaNodeType,DSRArea,RouteID,RouteType,Route
	FROM #SalesHier
