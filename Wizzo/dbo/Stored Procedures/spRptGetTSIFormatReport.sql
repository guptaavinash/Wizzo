...
--EXEC [spRptGetTSIFormatReport]
CREATE PROC [dbo].[spRptGetTSIFormatReport]
...
BEGIN
	...
	*/
	...
	--SELECT * FROM [#TMPSales] WHERE CovAreaId in(30,153) ORDER BY CovAreaId,Category,StoreId--,ProductNodeID
