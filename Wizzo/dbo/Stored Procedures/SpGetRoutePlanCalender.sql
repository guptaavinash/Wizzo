...
-- SpGetRoutePlanCalender '7A4CF64A-0EDE-4D7B-AD6E-4B0EC282E099'
CREATE PROCEDURE [dbo].[SpGetRoutePlanCalender] 
	@PDA_IMEI VARCHAR(50),
...
BEGIN
	...
	UPDATE R SET RouteName=ISNULL(M.Descr,'NA') FROM #tblReport R INNER JOIN #Route P ON P.PlannedDate=R.PlannedDate INNER JOIN tblCompanySalesStructureRouteMstr(nolock) M ON M.NodeID=P.RouteNodeID WHERE flgPlanned=1
