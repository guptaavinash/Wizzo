...
--select * from tbltelecallerlistforday where Date='22-Nov-2021'
...
--[spSchemeDetailByStoreN]    67498,'01-dec-2021'
CREATE proc [dbo].[spSchemeDetailByStoreN]   
@Storeid int,  
@Date datetime  
AS  
begin  
