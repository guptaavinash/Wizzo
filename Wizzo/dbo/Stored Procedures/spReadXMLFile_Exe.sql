...
CREATE proc [dbo].[spReadXMLFile_Exe]
@XML XML,
@DataSourceId int,
@FileSize int,
...
@udt_PotentialDBRetailerData_XMLSaving udt_PotentialDBRetailerData_XMLSaving
...
FROM OPENXML(@hDoc,'database/table[@name=''tblStoreCartonDetails'']/row')
	...
	--- Day End File
	INSERT INTO @udt_RawDataDayEndDet(IMEINo,StartTime,EndTime,DayEndFlag,ForDate,AppVersionID,[BatteryStatus],[LatCode],[LongCode],[Address],[PinCode],[City],[State])
	SELECT IMEINo,StartTime,EndTime,DayEndFlag,ForDate,AppVersionID,[BatteryStatus],[LatCode],[LongCode],[Address],[PinCode],[City],[State]
	...
	--- Potential Data Retailer Saving
	insert into @udt_PotentialDBRetailerData_XMLSaving(DBNodeID,DBNodeType,[RetailerCode],[RetailerName],[Address],[Comment],[RetFeedback])	
	SELECT  DBNodeID,DBNodeType,[RetailerCode],[RetailerName],[Address],[Comment],[RetFeedback]

	FROM OPENXML(@hDoc, 'database/table[@name=''tblDistRetAddressDetail'']/row')
	WITH 
	(
		DBNodeID [nvarchar](500) 'col[@name=''DBNodeID'']',
		DBNodeType [nvarchar](500) 'col[@name=''DBNodeType'']',
		[RetailerCode] [nvarchar](500) 'col[@name=''RetailerCode'']'	,
		[RetailerName] [nvarchar](500) 'col[@name=''RetailerName'']'	,
		[Address] [nvarchar](500) 'col[@name=''Address'']'	,
		[Comment] [nvarchar](500) 'col[@name=''Comment'']'	,
		[RetFeedback] [nvarchar](500) 'col[@name=''RetFeedback'']'		
