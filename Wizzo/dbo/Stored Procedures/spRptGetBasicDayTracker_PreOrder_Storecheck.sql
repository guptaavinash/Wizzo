...
--[spRptGetBasicDayTracker_PreOrder_Storecheck]'27-Jan-2022',4492,''
CREATE PROC [dbo].[spRptGetBasicDayTracker_PreOrder_Storecheck]
@strDate DATE,
@LoginId INT,
...
AS
	...
	*/
	...
	[Total Sales^Value] = ROUND(ISNULL(#ForUpdate_CovArea.TotOrderVal,0),0), [Total Sales^Lines/Bill] =CASE ISNULL(#ForUpdate_CovArea.Prod_Call,0) WHEN 0 THEN NULL ELSE ROUND(#ForUpdate_CovArea.TotLinesOrdered/CAST(#ForUpdate_CovArea.Prod_Call AS FLOAT),2) END
