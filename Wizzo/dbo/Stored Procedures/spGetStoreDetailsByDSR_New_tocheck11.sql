...
-- =============================================
--exec [spGetStoreDetailsByDSR_NEw]194,130,237,'24-Jan-2022'
CREATE PROCEDURE [dbo].[spGetStoreDetailsByDSR_New_tocheck11]
@SEAreaId INT,
@SEAreaNodeType INT,
@SalesmanId INT,
@Date DATE
...
BEGIN
	...
	SELECT * FROM #RouteList WHERE RouteId=48234
	...
	SELECT * FROM #Target WHERE RouteNodeId=48234
