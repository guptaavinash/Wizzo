...
--[spRptGetBasicDayTracker_PreOrder_FullMonth]'31-Jan-2022',4492,''
CREATE PROC [dbo].[spRptGetBasicDayTracker_PreOrder_FullMonth_backup03Mar2022]
@strDate DATE,
@LoginId INT,
...
AS	
	...
	*/
	...
	INSERT INTO #RptAttendance(RSMAreaId,RSMAreaNodeType,[RSM Area],StateHeadAreaNodeID,StateHeadAreaNodeType,StateHeadArea,ASMAreaId,ASMAreaNodeType,[ASM Area],SOAreaId,SOAreaNodeType,[SO Area],CoverageAreaId,CoverageAreaNodeType,CoverageArea,SalesmanNodeId,SalesmanNodeType,Salesman,[User Status],DOJ,[User Contact])
	SELECT DISTINCT RSMAreaId,RSMAreaNodeType,[RSM Area],StateHeadAreaNodeID,StateHeadAreaNodeType,StateHeadArea,ASMAreaId,ASMAreaNodeType,[ASM Area],SOAreaId,SOAreaNodeType,[SO Area],CoverageAreaId,CoverageAreaNodeType,CoverageArea,SalesmanNodeId,SalesmanNodeType,Salesman,[User Status],DOJ,[User Contact] FROM #Final
