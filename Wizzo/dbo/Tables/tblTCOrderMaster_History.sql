CREATE TABLE [dbo].[tblTCOrderMaster_History] (
    ...
    [GPValue]                 SMALLINT        NOT NULL,
    [FocBndAlrAch]            TINYINT         NOT NULL,
    [FocBndNowAch]            TINYINT         NOT NULL,
    [FocBndSBFOrd]            INT             NOT NULL,
    [FocBndSBFQtyOrd]         INT             NOT NULL,
    [FocBndSBFValueOrd]       NUMERIC (18, 2) NOT NULL,
    [SBDSBFOrd]               INT             NOT NULL,
    [SBDTotalGap]             INT             NOT NULL,
