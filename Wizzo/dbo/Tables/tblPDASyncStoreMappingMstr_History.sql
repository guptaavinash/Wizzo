CREATE TABLE [dbo].[tblPDASyncStoreMappingMstr_History] (
    ...
    [PersonId]                              INT              NULL,
    [PersonType]                            INT              NULL,
    [flgToShowInDuplicate]                  TINYINT          CONSTRAINT [DF_tblPDASyncStoreMappingMstr_History_flgToShowInDuplicate] DEFAULT ((0)) NULL,
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'0:Yes, 1:No', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'tblPDASyncStoreMappingMstr_History', @level2type = N'COLUMN', @level2name = N'flgToShowInDuplicate';
